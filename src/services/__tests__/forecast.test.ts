...
import stromGlassNormalizedResponseFixture from '@test/fixtures/stormglass_normalized_response_3_hours.json';
...
describe('Forecast Service', () => {
    ...
    it('should reeturn the forecast for a list of beaches', async () => {
        mockedStormGlassService.fetchPoints.mockResolvedValue(stromGlassNormalizedResponseFixture);
